'''
Calculate and plot time-dependent sidereal oscillograms including matter effects in parallel using standard nuSQuIDS atmospheric neutrino oscillation probabilities.
