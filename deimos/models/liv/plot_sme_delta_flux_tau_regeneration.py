'''
Same as plot_delta_flux_tau_regeneration.py, but adding SME operator.
...
if __name__ == "__main__" :
    ...
    E_values_GeV = np.geomspace(1., E_GeV, num=200)
    E_scale = "log"
    ...
    for initial_flavor, initial_nubar in initial_states :
        ...
        for final_flavor in range(calculator.num_neutrinos) :
            for final_nubar in [False, True] :
                ...
                flavor_final_flux_sme = final_flux_sme[:, coszen_idx, final_flavor, final_rho]
                ...
                this_ax.step( E_values_GeV, flavor_final_flux_sme, color="dodgerblue", linestyle=":", lw=2, label="Final flux (SME)", where="mid" )
